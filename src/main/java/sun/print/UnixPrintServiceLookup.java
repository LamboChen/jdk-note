...
public class UnixPrintServiceLookup extends PrintServiceLookup
    ...
    static {
         ...
         * for PrintServices.
         */
        String pollStr = AccessController.doPrivileged(
         ...
         */
        String refreshTimeStr = AccessController.doPrivileged(
         ...
         */
        if (isAIX()) {
            String aixPrinterEnumerator = AccessController.doPrivileged(
