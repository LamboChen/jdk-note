...
public interface Map<K, V> {
     ...
     * @since 1.8
     */
    // 删除元素，并且进行 value check。 不正确时不进行删除操作
     ...
     * @since 1.8
     */
    // 将 value 和 function 计算所得值进行 merge 。 value 优先级较低. 更新节点信息
