...
class Thread implements Runnable {
     ...
     */
    // 给调度程序的一个提示，即当前线程愿意产生其当前使用的处理器。调度程序可以忽略此提示
     ...
     */
    // sleep 当前线程，millis 指定 sleep 毫秒数
     ...
     */
    // 设置当前线程是否为守护线程。on=true 则表示守护线程，false 为非守护线程
